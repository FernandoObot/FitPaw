                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      _WeekSelector(
                        isSelected: _isWeekSelected,
                        onTap: () => setState(() => _isWeekSelected = !_isWeekSelected),
                      ),
                    ],
                  ),
...
class _WeekSelector extends StatelessWidget {
  const _WeekSelector({required this.isSelected, required this.onTap});
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(16 * scale),
            border: Border.all(
              color: isSelected ? Colors.transparent : const Color(0xFFD0D0D0),
            ),
          ),
          child: Row(
            children: [
