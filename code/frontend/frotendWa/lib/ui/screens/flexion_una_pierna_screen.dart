                      ...
                      children: [
                        ...
                        _DetailCard(
                          ...
                          onTap: () => _showOptionSheet(
                            ...
                            options: const ['8 reps por pierna', '10 reps por pierna', '12 reps por pierna', '15 reps por pierna'],
  ...
  Future<void> _guardarPlan() async {
    ...
    try {
      ...
      final String? conflictError = await _scheduleService.checkExerciseConflicts(
        nombreEjercicio: 'Flexion de una pierna',
